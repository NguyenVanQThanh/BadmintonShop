...
public class AuthService {
    ...
    private void saveUserToken(Account user, String jwtToken) {
        var token = Token.builder()
                ...
                .status(com.badmintonshop.shared.entity.enums.TokenStatus.VALID)
                .build();
    ...
    private void revokeAllUserTokens(Account user) {
        ...
        // Batch update status to Revoked
        validUserTokens.forEach(token -> {
            token.setStatus(com.badmintonshop.shared.entity.enums.TokenStatus.REVOKED);
        });
